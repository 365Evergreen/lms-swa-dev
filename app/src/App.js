...
const App = () => (_jsxs(_Fragment, { children: [_jsx(Header, {}), _jsx("main", { style: { paddingTop: 80 }, children: _jsxs(Routes, { children: [_jsx(Route, { path: "/landing", element: _jsx(LandingPage, {}) }), _jsx(Route, { path: ":type/:slug", element: _jsx(ContentRouter, {}) }), _jsx(Route, { path: ":parent/:slug", element: _jsx(WPPage, {}) }), _jsx(Route, { path: "/*", element: _jsx(Hero, {}) })] }) })] }));
export default App;
